...
const AprovarParceria = () => {
    ...
    const handleAprovarParceria = async () => {
        try {
            const parceriaAprovacaoDto = {
                IdLojaPioneer: parseInt(id), // ID da loja da URL
            };

            const response = await api.post(`/Vendas/AprovarParceria/${idLojaLogada}`, parceriaAprovacaoDto);
    ...
    return (
        <div className="aprovar-parceria-container">
            ...
            <Button
                label="Aprovar Parceria"
                onClick={handleAprovarParceria}
            />
...
export default AprovarParceria;